<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Allowances.aspx.cs" Inherits="Project_Application.Allowances" %>
...
<head>
    ...
    <link rel="stylesheet" href="allowances.css" />
</head>
<body>
...
<asp:TextBox ID="AllowanceIdTextBox" runat="server" placeholder="Allowance ID"></asp:TextBox>
<asp:TextBox ID="TypeTextBox" runat="server" placeholder="Type"></asp:TextBox>
<asp:Button ID="AddAllowanceButton" runat="server" Text="Add Allowance" OnClick="AddAllowanceButton_Click" />

                <br />
                <br />
                <!-- Display allowance records here -->
